...
export class Backend implements backendInterface {
    ...
    async addDailyRecord(arg0: Array<Meal>, arg1: Timestamp): Promise<DailyRecordId> {
        if (this.processError) {
            try {
                const result = await this.actor.addDailyRecord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getIngredientsByCategory(arg0: CategoryName): Promise<Array<Ingredient>> {
        if (this.processError) {
            try {
