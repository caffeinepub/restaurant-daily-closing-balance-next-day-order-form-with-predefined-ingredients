...
const CARD_ORANGE: React.CSSProperties = {
  background: "#FFF0E0",
...
export default function DailyEntryForm({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <Card style={CARD_ORANGE}>
        ...
        <CardContent>
          <div className="space-y-2 mb-4">
            <Label
              htmlFor={`${ocidPrefix}-balance-date`}
              className="text-sm font-semibold"
            >
              Balance Date <span className="text-destructive">*</span>
            </Label>
            <Input
              id={`${ocidPrefix}-balance-date`}
              type="date"
              value={balanceDate}
              onChange={(e) => setBalanceDate(e.target.value)}
              className="w-full sm:w-56"
              data-ocid={`${ocidPrefix}.date.input`}
            />
            {orderDate && (
      ...
      {/* Step 1+2 */}
      <Card
        className={isStepDisabled ? "opacity-50 pointer-events-none" : ""}
        style={CARD_ORANGE}
      >
        <CardHeader>
          ...
          <div>
            ...
            >
              <SelectTrigger
                ...
                data-ocid={`${ocidPrefix}.category.select`}
              >
            ...
            <div>
              ...
              <div className="relative mb-3">
                ...
                <Input
                  ...
                  data-ocid={`${ocidPrefix}.search.input`}
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      e.preventDefault();
                      if (
              ...
              <div className="flex gap-3 mb-3">
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    min="0"
                    step="any"
                    data-ocid={`${ocidPrefix}.balance.input`}
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        e.preventDefault();
              ...
              {!showFloatingAddBtn && (
                <Button
                  ...
                  className="w-full mt-3 text-white font-bold text-base gap-2"
                  style={{ background: "#1a3a5c" }}
                  data-ocid={`${ocidPrefix}.add.primary_button`}
                >
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                data-ocid={`${ocidPrefix}.view_edit.button`}
              >
                View &amp; Edit
              </Button>
            </div>
            ...
            <div className="space-y-2">
              {cartItems.map((item, idx) => (
                <div
                  ...
                  data-ocid={`${ocidPrefix}.cart.item.${idx + 1}`}
                >
                  ...
                  <Button
                    ...
                    data-ocid={`${ocidPrefix}.cart.edit_button.${idx + 1}`}
                  >
                  ...
                  <Button
                    ...
                    data-ocid={`${ocidPrefix}.cart.delete_button.${idx + 1}`}
                  >
      ...
      >
        <AlertDialogContent
          ...
          data-ocid={`${ocidPrefix}.duplicate.modal`}
        >
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel
              ...
              data-ocid={`${ocidPrefix}.duplicate.cancel_button`}
            >
              Keep Separate
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={handleDuplicateConfirm}
              data-ocid={`${ocidPrefix}.duplicate.confirm_button`}
            >
              Combine
            </AlertDialogAction>
          </AlertDialogFooter>
      ...
      <Dialog open={showViewModal} onOpenChange={setShowViewModal}>
        <DialogContent
          ...
          data-ocid={`${ocidPrefix}.viewedit.dialog`}
        >
          <DialogHeader>
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    <Input
                      ...
                      data-ocid={`${ocidPrefix}.viewedit.balance.input.${idx + 1}`}
                    />
                  </div>
                  <div className="flex-1">
                    ...
                    <Input
                      ...
                      data-ocid={`${ocidPrefix}.viewedit.order.input.${idx + 1}`}
                    />
                  </div>
                  <Button
                    variant="ghost"
                    ...
                    data-ocid={`${ocidPrefix}.viewedit.delete_button.${idx + 1}`}
                  >
          ...
          <div className="flex gap-2 pt-2">
            <Button
              ...
              className="flex-1"
              data-ocid={`${ocidPrefix}.viewedit.cancel_button`}
            >
              Cancel
            </Button>
            <Button
              ...
              className="flex-1"
              data-ocid={`${ocidPrefix}.viewedit.save_button`}
            >
              Save Changes
            </Button>
          </div>
